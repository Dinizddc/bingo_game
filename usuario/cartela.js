...
while (quantidadeCartelas < 1 || quantidadeCartelas > 5 || isNaN(quantidadeCartelas)) {
    quantidadeCartelas = parseInt(prompt("Quantas cartelas você deseja gerar? (Digite um número entre 1 e 5)", "1"));
    if (quantidadeCartelas < 1 || quantidadeCartelas > 5 || isNaN(quantidadeCartelas)) {
    ...
    for (let i = 0; i < 5; i++) {
        ...
        for (let j = 0; j < 5; j++) {
            ...
            if (i !== 2 || j !== 2) {
                ...
                celula.innerHTML = '<img src="./icone/biblia logo.png" alt="Imagem Central" class="imagem">';
            }
